            ...
            <div class="column is-4">
                ...
                <div class="field">
                    ...
                    <template v-if="$v.username.$error">
                        ...
                        <p class="help is-danger" v-if="!$v.username.minLength">min 5</p>
                        <p class="help is-danger" v-if="!$v.username.maxLength">max 20</p>
                    </template>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control has-icons-left has-icons-right">
                        <input v-model="$v.password.$model" :class="{'is-danger': $v.password.$error}" class="input" type="password" />
                        <span class="icon is-small is-left">
                    ...
                    <template v-if="$v.password.$error">
                        ...
                        <p class="help is-danger" v-if="!$v.password.minLength">8</p>
                        <p class="help is-danger" v-if="!$v.password.complex">easy</p>
                    </template>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control has-icons-left has-icons-right">
                        <input v-model="$v.confirm_password.$model" :class="{'is-danger': $v.confirm_password.$error}" class="input" type="password" />
                        <span class="icon is-small is-left">
                            <i class="fas fa-lock"></i>
                        </span>
                    </div>
                    <template v-if="$v.confirm_password.$error">
                        <p class="help is-danger" v-if="!$v.confirm_password.sameAs">This field is required</p>
                    </template>
                </div>
                ...
                <div class="field">
                    ...
                    <template v-if="$v.first_name.$error">
                        ...
                        <p class="help is-danger" v-if="!$v.first_name.maxLength">max 150</p>
                    </template>
                </div>
                ...
                <div class="field">
                    ...
                    <template v-if="$v.last_name.$error">
                        ...
                        <p class="help is-danger" v-if="!$v.last_name.maxLength">max 150</p>
                    </template>
                </div>
